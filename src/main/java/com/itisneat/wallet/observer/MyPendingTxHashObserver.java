 ...
 *
 */
public class MyPendingTxHashObserver implements Observer<Transaction> {
	...
	public MyPendingTxHashObserver(Observable<org.web3j.protocol.core.methods.response.Transaction> observable) {
